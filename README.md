...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 503,996 | 🐛 106 | 📅 2026-09-02 list project.*
...
* 📦 [Python](https://github.com/knative/docs/tree/master/docs/serving/samples/hello-world/helloworld-python) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
* 📦 [Scala](https://github.com/knative/docs/tree/master/docs/serving/samples/hello-world/helloworld-scala) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
* 📦 [Clojure](https://github.com/knative/docs/tree/master/community/samples/serving/helloworld-clojure) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
* 📦 [Haskell](https://github.com/knative/docs/tree/master/community/samples/serving/helloworld-haskell) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
...
* Node.js
  * 📦 [Hello World](https://github.com/knative/docs/tree/master/docs/serving/samples/hello-world/helloworld-nodejs) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
...
* Ruby
  * 📦 [Ruby sample](https://github.com/knative/docs/tree/main/code-samples/serving/hello-world/helloworld-ruby) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
...
* 📦 PHP
  * 📦 [Hello World](https://github.com/knative/docs/tree/master/docs/serving/samples/hello-world/helloworld-php) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
...
* Kotlin:
  * 📦 [Kotlin Knative sample](https://github.com/knative/docs/tree/master/docs/serving/samples/hello-world/helloworld-kotlin) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
...
* Java:
  * 📦 [Spring Boot](https://github.com/knative/docs/tree/main/docs/serving/samples/hello-world/helloworld-java-spring) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
...
* Shell
  * 📦 [Shell Knative sample](https://github.com/knative/docs/tree/master/docs/serving/samples/hello-world/helloworld-shell) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
  * 📦 [sh server](https://github.com/wietsevenema/sh-server/) ⭐ 5 | 🐛 0 | 🌐 Shell | 📅 2020-03-24
* Dart
  * 📦 [Dart](https://github.com/knative/docs/tree/main/code-samples/community/serving/helloworld-dart) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
  ...
  * 🎬 [Go full-stack with Kotlin or Dart on Google Cloud](https://www.youtube.com/watch?v=JwCmu_INnCg)
* Elixir:
  * 📦 [Elixir](https://github.com/knative/docs/tree/master/community/samples/serving/helloworld-elixir) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
  * 🎬 [Elixir](https://www.youtube.com/watch?v=6Jo8WlWq-Fw)
* Rust
  * 📦 [Rust Knative sample](https://github.com/knative/docs/tree/master/community/samples/serving/helloworld-rust) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
  * 📦 [Rust sample](https://github.com/gsquire/rust_bin) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2020-09-12
* C# and .NET
  * 📦 [C#](https://github.com/knative/docs/tree/master/docs/serving/samples/hello-world/helloworld-csharp) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
...
* Swift
  * 📦 [helloworld-swift](https://github.com/knative/docs/tree/master/community/samples/serving/helloworld-swift) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
...
* R
  * 📦 [R Knative Hello World](https://github.com/knative/docs/tree/master/community/samples/serving/helloworld-rserver) ⭐ 5,086 | 🐛 48 | 🌐 HTML | 📅 2026-09-07
...
* [Pulumi](https://www.pulumi.com/):
  * 📦 [Typescript sample](https://github.com/pulumi/examples/tree/master/gcp-ts-cloudrun) ⭐ 2,586 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-07: example of deploying a custom Docker image into Google Cloud Run service using TypeScripe.
...
* [Datasette](https://datasette.readthedocs.io/en/stable/changelog.html#datasette-publish-cloudrun): Publish your [Datasette](https://github.com/simonw/datasette) ⭐ 11,441 | 🐛 717 | 🌐 Python | 📅 2026-09-02 to Cloud Run.
