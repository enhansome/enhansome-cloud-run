...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,665 | 🐛 106 | 📅 2026-09-02 list project.*
...
* Java:
  ...
  * 📦 [Micronaut sample](https://github.com/micronaut-projects/micronaut-gcp/tree/master/examples/hello-world-cloud-run) ⭐ 57 | 🐛 47 | 🌐 Java | 📅 2026-09-21
  * 📦 [Micronaut with GraalVM](https://github.com/micronaut-projects/micronaut-gcp/tree/master/examples/hello-world-cloud-run-graal) ⭐ 57 | 🐛 47 | 🌐 Java | 📅 2026-09-21
...
* Java [Jib](https://github.com/GoogleContainerTools/jib) ⭐ 14,449 | 🐛 254 | 🌐 Java | 📅 2026-07-15: Build container images for your Java applications.
...
* [Pulumi](https://www.pulumi.com/):
  * 📦 [Typescript sample](https://github.com/pulumi/examples/tree/master/gcp-ts-cloudrun) ⭐ 2,586 | 🐛 144 | 🌐 TypeScript | 📅 2026-09-22: example of deploying a custom Docker image into Google Cloud Run service using TypeScripe.
...
* [Datasette](https://datasette.readthedocs.io/en/stable/changelog.html#datasette-publish-cloudrun): Publish your [Datasette](https://github.com/simonw/datasette) ⭐ 11,478 | 🐛 670 | 🌐 Python | 📅 2026-09-21 to Cloud Run.
