...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 503,333 | 🐛 106 | 📅 2026-09-02 list project.*
...
* Java [Jib](https://github.com/GoogleContainerTools/jib) ⭐ 14,451 | 🐛 253 | 🌐 Java | 📅 2026-07-15: Build container images for your Java applications.
...
* [Pulumi](https://www.pulumi.com/):
  * 📦 [Typescript sample](https://github.com/pulumi/examples/tree/master/gcp-ts-cloudrun) ⭐ 2,586 | 🐛 144 | 🌐 TypeScript | 📅 2026-09-03: example of deploying a custom Docker image into Google Cloud Run service using TypeScripe.
...
* [Datasette](https://datasette.readthedocs.io/en/stable/changelog.html#datasette-publish-cloudrun): Publish your [Datasette](https://github.com/simonw/datasette) ⭐ 11,428 | 🐛 717 | 🌐 Python | 📅 2026-09-02 to Cloud Run.
