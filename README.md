...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 500,629 | 🐛 105 | 📅 2026-08-21 list project.*
...
* Java:
  ...
  * 📦 [Micronaut sample](https://github.com/micronaut-projects/micronaut-gcp/tree/master/examples/hello-world-cloud-run) ⭐ 57 | 🐛 51 | 🌐 Java | 📅 2026-08-27
  * 📦 [Micronaut with GraalVM](https://github.com/micronaut-projects/micronaut-gcp/tree/master/examples/hello-world-cloud-run-graal) ⭐ 57 | 🐛 51 | 🌐 Java | 📅 2026-08-27
...
* [Pulumi](https://www.pulumi.com/):
  * 📦 [Typescript sample](https://github.com/pulumi/examples/tree/master/gcp-ts-cloudrun) ⭐ 2,585 | 🐛 147 | 🌐 TypeScript | 📅 2026-08-27: example of deploying a custom Docker image into Google Cloud Run service using TypeScripe.
...
* [Datasette](https://datasette.readthedocs.io/en/stable/changelog.html#datasette-publish-cloudrun): Publish your [Datasette](https://github.com/simonw/datasette) ⭐ 11,413 | 🐛 710 | 🌐 Python | 📅 2026-08-14 to Cloud Run.
