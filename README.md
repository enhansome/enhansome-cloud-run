...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,540 | 🐛 106 | 📅 2026-09-02 list project.*
...
* Java:
  ...
  * 📦 [Micronaut sample](https://github.com/micronaut-projects/micronaut-gcp/tree/master/examples/hello-world-cloud-run) ⭐ 57 | 🐛 48 | 🌐 Java | 📅 2026-09-18
  * 📦 [Micronaut with GraalVM](https://github.com/micronaut-projects/micronaut-gcp/tree/master/examples/hello-world-cloud-run-graal) ⭐ 57 | 🐛 48 | 🌐 Java | 📅 2026-09-18
...
* Java [Jib](https://github.com/GoogleContainerTools/jib) ⭐ 14,450 | 🐛 251 | 🌐 Java | 📅 2026-07-15: Build container images for your Java applications.
...
* [Pulumi](https://www.pulumi.com/):
  * 📦 [Typescript sample](https://github.com/pulumi/examples/tree/master/gcp-ts-cloudrun) ⭐ 2,586 | 🐛 144 | 🌐 TypeScript | 📅 2026-09-18: example of deploying a custom Docker image into Google Cloud Run service using TypeScripe.
...
* [Datasette](https://datasette.readthedocs.io/en/stable/changelog.html#datasette-publish-cloudrun): Publish your [Datasette](https://github.com/simonw/datasette) ⭐ 11,473 | 🐛 669 | 🌐 Python | 📅 2026-09-17 to Cloud Run.
