...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 503,686 | 🐛 106 | 📅 2026-09-02 list project.*
...
* 📦 [Python](https://github.com/knative/docs/tree/master/docs/serving/samples/hello-world/helloworld-python) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
* 📦 [Scala](https://github.com/knative/docs/tree/master/docs/serving/samples/hello-world/helloworld-scala) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
* 📦 [Clojure](https://github.com/knative/docs/tree/master/community/samples/serving/helloworld-clojure) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
* 📦 [Haskell](https://github.com/knative/docs/tree/master/community/samples/serving/helloworld-haskell) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
...
* Node.js
  * 📦 [Hello World](https://github.com/knative/docs/tree/master/docs/serving/samples/hello-world/helloworld-nodejs) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
...
* Ruby
  * 📦 [Ruby sample](https://github.com/knative/docs/tree/main/code-samples/serving/hello-world/helloworld-ruby) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
...
* 📦 PHP
  * 📦 [Hello World](https://github.com/knative/docs/tree/master/docs/serving/samples/hello-world/helloworld-php) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
...
* Kotlin:
  * 📦 [Kotlin Knative sample](https://github.com/knative/docs/tree/master/docs/serving/samples/hello-world/helloworld-kotlin) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
...
* Java:
  * 📦 [Spring Boot](https://github.com/knative/docs/tree/main/docs/serving/samples/hello-world/helloworld-java-spring) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
  * 📦 [Micronaut sample](https://github.com/micronaut-projects/micronaut-gcp/tree/master/examples/hello-world-cloud-run) ⭐ 57 | 🐛 49 | 🌐 Java | 📅 2026-09-05
  * 📦 [Micronaut with GraalVM](https://github.com/micronaut-projects/micronaut-gcp/tree/master/examples/hello-world-cloud-run-graal) ⭐ 57 | 🐛 49 | 🌐 Java | 📅 2026-09-05
...
* Shell
  * 📦 [Shell Knative sample](https://github.com/knative/docs/tree/master/docs/serving/samples/hello-world/helloworld-shell) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
  * 📦 [sh server](https://github.com/wietsevenema/sh-server/) ⭐ 5 | 🐛 0 | 🌐 Shell | 📅 2020-03-24
* Dart
  * 📦 [Dart](https://github.com/knative/docs/tree/main/code-samples/community/serving/helloworld-dart) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
  ...
  * 🎬 [Go full-stack with Kotlin or Dart on Google Cloud](https://www.youtube.com/watch?v=JwCmu_INnCg)
* Elixir:
  * 📦 [Elixir](https://github.com/knative/docs/tree/master/community/samples/serving/helloworld-elixir) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
  * 🎬 [Elixir](https://www.youtube.com/watch?v=6Jo8WlWq-Fw)
* Rust
  * 📦 [Rust Knative sample](https://github.com/knative/docs/tree/master/community/samples/serving/helloworld-rust) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
  * 📦 [Rust sample](https://github.com/gsquire/rust_bin) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2020-09-12
* C# and .NET
  * 📦 [C#](https://github.com/knative/docs/tree/master/docs/serving/samples/hello-world/helloworld-csharp) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
...
* Swift
  * 📦 [helloworld-swift](https://github.com/knative/docs/tree/master/community/samples/serving/helloworld-swift) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
...
* R
  * 📦 [R Knative Hello World](https://github.com/knative/docs/tree/master/community/samples/serving/helloworld-rserver) ⭐ 5,086 | 🐛 47 | 🌐 HTML | 📅 2026-09-03
...
* [Datasette](https://datasette.readthedocs.io/en/stable/changelog.html#datasette-publish-cloudrun): Publish your [Datasette](https://github.com/simonw/datasette) ⭐ 11,431 | 🐛 718 | 🌐 Python | 📅 2026-09-02 to Cloud Run.
